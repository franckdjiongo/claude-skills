---
name: brand-forge
description: Automate full branding for any project, product, startup, or idea. Spawns an expert team of agents (researcher, naming expert, trademark verifier, copywriter, creative director) to deliver a complete brand package including verified name, slogans, logo concepts, AI image generation prompts, color palette, and typography. Use when the user mentions branding, naming a project, creating a logo, finding a product name, building brand identity, needs a slogan/tagline, or wants marketing assets for a new idea. Also triggers on "brand forge", "name my app", "I need a name for", "logo for my project", "branding for my startup".
---
