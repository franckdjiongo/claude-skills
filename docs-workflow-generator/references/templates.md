...
> **Note**: Replace `[INSTRUCTIONS_FILE]` with the appropriate file for the target LLM:
...
Follow [INSTRUCTIONS_FILE] instructions.

Workflow:
1. Read [INSTRUCTIONS_FILE], then PRD and roadmap.
